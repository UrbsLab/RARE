#Code for running Experiment 2
#Must be run after running the code "RARE Functions Definition"

# In[ ]:


#Experiment 2: 1 Bin, 0.05 Noise, No Expert Knowlege
for replicate in range (0,1):
    print('Experiment 2')
        
    #Creating the simulated dataset
    sim_data, cutoff = RVDS_One_Bin(1000, 50, 10, 0.05, 'mean', 0.05)
    
    #Running RARE
    bin_feature_matrix, common_features_and_bins_matrix, amino_acid_bins, amino_acid_bin_scores, rare_feature_MAF_dict, common_feature_MAF_dict, rare_feature_df, common_feature_df, MAF_0_features = RARE(False, None, None, 3000, sim_data, 'Class', 0.05, 50, 5, 25, 'Relief', True, False, 500, 0.8, 0.1, 0.4)
