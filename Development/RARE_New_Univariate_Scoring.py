#Updated version of RARE (July 2021) with updated versions of univariate scoring that suit the data and optimization task better than chi-square value
#New univariate scoring options: 
#(1) logistic regression odds ratio, (2) logistic regression prediction balanced accuracy score, (3) mutual information, (4) rank-biserial correlation (Glass 1966)
